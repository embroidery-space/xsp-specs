...
> You can find a practical OXS parser [in the Embroiderly codebase](https://github.com/embroidery-space/embroiderly/blob/main/crates/embroiderly-parsers/src/oxs.rs).
